platform "ubuntu-16.10-amd64" do |plat|
  ...
  plat.add_build_repository "http://pl-build-tools.delivery.puppetlabs.net/debian/pl-build-tools-release-#{plat.get_codename}.deb" unless ENV['USE_PL_BUILD_TOOLS'] == "no"
